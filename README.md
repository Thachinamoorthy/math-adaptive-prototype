...
The goal of this prototype is to demonstrate an AI-powered system that dynamically personalizes learning difficulty. It helps children (ages 5-10) practice basic math by adjusting puzzle difficulty based on their performance, aiming to keep them in their optimal challenge zone.
